  ...
  if (isSuccess) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
        ...
        <p className="text-gray-500 max-w-md mx-auto">The school has been successfully onboarded to LeonEd Africa. Redirecting to registry...</p>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600">Onboard a new school to the LeonEd Africa ecosystem.</p>
      </div>
