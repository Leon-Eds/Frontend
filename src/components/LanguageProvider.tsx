...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    "why.category": "Pourquoi LeonEd Africa ?",
    ...
    "footer.rights": "© 2026 LeonEd Africa. Tous droits réservés.",
  ...
  es: {
    ...
    "why.category": "¿Por qué LeonEd Africa?",
    ...
    "footer.rights": "© 2026 LeonEd Africa. Todos los derechos reservados.",
  ...
  de: {
    ...
    "why.category": "Warum LeonEd Africa?",
    ...
    "footer.rights": "© 2026 LeonEd Africa. Alle Rechte vorbehalten.",
  ...
  pt: {
    ...
    "why.category": "Porquê a LeonEd Africa?",
    ...
    "footer.rights": "© 2026 LeonEd Africa. Todos os direitos reservados.",
  ...
  zh: {
    ...
    "why.category": "为什么选择 LeonEd Africa？",
    ...
    "footer.rights": "© 2026 LeonEd Africa. 版权所有。",
    "login.title": "欢迎回来",
