...
export const Step4Success: React.FC<Step4Props> = ({ data, onReset }) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      {/* Main Success Area */}
      <div className="lg:col-span-8 bg-white rounded-3xl p-16 shadow-sm flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-4xl font-bold text-gray-900 mb-4 max-w-md leading-tight">
          Student Successfully Enrolled
        </h2>
        
        <p className="text-lg text-gray-600 mb-8 max-w-md">
          The academic records for <span className="font-bold text-gray-900">{data.fullName || "Kofi Mensah"}</span> have been architected and finalized.
        </p>
        ...
        <div className="inline-flex items-center gap-2 rounded-full bg-green-100 px-4 py-2 text-sm font-bold text-[#053d26] mb-12">
          ...
          <span>Admission ID: {data.admissionNumber || "LEA-2024-8842"}</span>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md mb-8">
          <button className="flex-1 flex items-center justify-center gap-2 py-4 rounded-full bg-[#053d26] text-white font-bold hover:bg-[#042c1b] transition-colors">
        ...
        <a href="/dashboard" className="flex items-center gap-2 font-bold text-[#b05e1c] hover:text-[#965017] transition-colors">
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center pb-4 border-b border-gray-100">
              ...
              <span className="text-sm font-bold text-gray-900">{data.classId || "Senior Architecture I"}</span>
            </div>
            <div className="flex justify-between items-center pb-4 border-b border-gray-100">
              <span className="text-sm text-gray-500">Term</span>
              <span className="text-sm font-bold text-gray-900">Fall Semester 2024</span>
            </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">All regional nodes updated in 12ms.</p>
          </div>
        </div>
      </div>
    </div>
